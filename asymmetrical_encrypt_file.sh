...
declare -a DEPENDENCIES=('./_fasymmetrical_encrypt_file.sh'\
                        )
...
#
# TASK : _fasymmetrical_encrypt_file.sh - START
_task="Asymmetrically encrypts File: $_input_file_name"
_cmd="asymmetrical_encrypt_file $_publicKey $_input_file_name"
echo "$(date) - [$SCRIPT_NAME ($SCRIPT_PID)] - $_fname - $_task - Start"
